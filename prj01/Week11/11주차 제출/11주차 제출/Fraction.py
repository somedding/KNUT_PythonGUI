...
class Fraction():
    ...
    def __sub__(self, oOtherFraction):
        ''' Subtract another Fraction object from self '''
        if not isinstance(oOtherFraction, Fraction):
            raise TypeError('Second value in attempt to subtract is not a Fraction')
        ...
        oSubtractedFraction = Fraction(newNumerator, newDenominator)
        return oSubtractedFraction
...
oFraction7 = Fraction(9, 4)
oFraction8 = Fraction(200, 300)
print('Sum of 9/4 and 200/300\n', oFraction8 - oFraction7)
